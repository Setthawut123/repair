...
<tr>
  ...
  <tr>
	<th colspan="3">สถานะการแจ้งซ่อม</th>
     ...
     <tr>
		<td/>เมื่อวันที่/เวลา : 
		<td colspan="2"/><?php echo $row2['time']; ?>
  </tr>
  <th colspan="3">รายละเอียดการดำเนินการ</th>
  </tr>
   <tr>
<?php 
$i=0;
...
?>
	    <tr>
	<td colspan="3"><center /><b />ครั้งที่<?php echo $i;?></td>
  </tr>
   <tr>
		<td/>เมื่อวันที่/เวลา : 
  ...
  <tr>
		<td/>รายละเอียด : 
		<td colspan="2"/>  <?php echo $row1['detail_fix'] ;?>
  </tr>
   <tr>
		<td/>ผู้ดำเนินการ
