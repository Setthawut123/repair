...
/*me*/
$sql ="SELECT * FROM repair WHERE r_id=$id_card";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$me_send = mysqli_num_rows($query);
	
$sql = "SELECT * FROM repair WHERE r_id=$id_card AND r_status = '$array_status[0]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$me_send0 = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE r_id=$id_card AND r_status = '$array_status[1]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$me_send1 = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE r_id=$id_card AND r_status = '$array_status[2]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$me_send2 = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE r_id=$id_card AND r_status = '$array_status[3]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$me_send3 = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE  r_status = '$array_status[1]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$fix = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE  r_status = '$array_status[0]'";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$none = mysqli_num_rows($query);

$sql = "SELECT * FROM repair WHERE r_status = '$array_status[0]' OR r_status = '$array_status[1]' ";
$query = mysqli_query($conn,$sql) or die (mysqli_error($conn));
$fix_all = mysqli_num_rows($query);
?>
