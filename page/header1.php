...
<body>
<nav>
<div id="logo">ระบบแจ้งซ่อมคอมพิวเตอร์</div>
        <label for="drop" class="toggle">เมนู</label>
        <input type="checkbox" id="drop" />
            <ul class="menu">
                <li><a href="..\page\admin.php">หน้าหลัก</a></li>
<?php 
...
?>
				<li>
                    <!-- First Tier Drop Down -->
                    <label for="drop-1" class="toggle">ค้นหาข้อมูล</label>
...
?>
				<li><a href="..\page\show_static.php">สถิติ</a></li>
